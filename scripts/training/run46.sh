#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════════
# Run46: Continue from run45 s8500 — same config, 10K more steps
# ═══════════════════════════════════════════════════════════════════
#
# Run45 achieved: pack 38→37%, ss 32→33%, gap 0.63→0.75, slope 2.04
# Secondary crossed packing in dynamics (42% vs 38% at s4500)
# RMSF consistently 0.39-0.53 Å (exp=0.46), Rg 94-98%
# 100K test: β=100 unstable (Q=0.990), β=200 borderline (Q=1.000)
#
# Run46 continues with fresh optimizer to push gap/slope further
# and test whether deeper landscape achieves 100K stability.
# ═══════════════════════════════════════════════════════════════════
...
RESUME="checkpoints/run45/run1/full/step008500.pt"
...
echo "════════════════════════════════════════════════════════"
echo "  Run46: Continue from run45 s8500, 10K steps"
