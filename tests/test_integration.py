...
class TestTrainingPipeline:
    ...
    def small_model(self, device):
        ...
        ss = SecondaryStructureEnergy(num_aa=NUM_AA, emb_dim=EMB_DIM, hidden=(16, 16)).to(device)
        pack = PackingEnergy(num_aa=NUM_AA, emb_dim=EMB_DIM, hidden_pair=(16, 16)).to(device)
...
class TestSimulationPipeline:
    ...
    def test_trajectory_saver(self, energy_model, random_coords, random_seq, device, tmp_path):
