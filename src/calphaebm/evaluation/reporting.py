# src/calphaebm/evaluation/reporting.py
...
from calphaebm.evaluation.metrics.rg import batch_rg, delta_rg
from calphaebm.evaluation.metrics.clash import batch_min_distances, clash_probability
from calphaebm.evaluation.io.loaders import load_trajectory_from_dir
...
class EvaluationReport:
    ...
    def save(self, out_dir: Path, prefix: str = "eval") -> None:
...
class TrajectoryEvaluator:
    ...
    def evaluate(
        ...
        if n_native > 0:
            ...
            if compute_q_smooth:
                q_smooths = np.array([
                    q_smooth(frame, native_i, native_j, native_d0,
    ...
    def evaluate_from_dir(
        ...
        # Load reference
        if ref_path is None:
            ref_path = os.path.join(traj_dir, "snapshot_0000.pt")
